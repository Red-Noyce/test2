                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoneikongjian/upload/changdiOrderMuBan.xls"
                        >批量导入场地预约数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('changdiOrder','导入导出')"
                                style="display: inline-block"
                                action="xiaoneikongjian/file/upload"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('changdiOrder','订单') && scope.row.changdiOrderTypes == 1 && role != '用户'" type="primary" icon="el-icon-sold-out" size="mini" @click="yiwancheng(scope.row.id)">已完成</el-button>
