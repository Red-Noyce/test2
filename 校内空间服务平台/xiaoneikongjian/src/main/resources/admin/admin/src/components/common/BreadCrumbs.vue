<template>
  <el-breadcrumb class="app-breadcrumb" separator="Orz " style="height:50px;backgroundColor:rgba(224, 240, 233, 1);borderRadius:0px;padding:0px 20px 0px 20px;boxShadow:4px 4px 2px#FFB3A7;borderWidth:0px;borderStyle:dotted solid double dashed;borderColor:rgba(255, 179, 167, 1);">
    ...
    breadcrumbStyleChange(val) {
      this.$nextTick(()=>{
        document.querySelectorAll('.app-breadcrumb .el-breadcrumb__separator').forEach(el=>{
          el.innerText = "Orz "
          el.style.color = "rgba(186, 210, 231, 1)"
        })
